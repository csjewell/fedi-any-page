...
This repository is a set of packages that help implement an ActivityPub
server that can run within different types of web-worker situations to
help static-page blogs get on the Fediverse.

It's incomplete as of yet.

Generated documentation is currently at
[fedi-any-page.curtisjewell.dev](https://fedi-any-page.curtisjewell.dev/)
but it is incomplete, as well.
