---
weight: 100
date: '2025-02-20T16:49:40-07:00'
title: 'Contributing'
---
...
Please do [report an issue on the issue tracker](https://github.com/csjewell/activitypub-ts-kit/issues/new/choose) if there's any bugfix, documentation improvement, or general enhancement you'd like to see in the repository! Please fully fill out all required fields in the most appropriate issue form.
...
With the exception of very small typos, all changes to this repository generally need to correspond to an [unassigned open issue marked as `status: accepting prs` on the issue tracker](https://github.com/csjewell/activitypub-ts-kit/issues?q=is%3Aissue+is%3Aopen+label%3A%22status%3A+accepting+prs%22+no%3Aassignee+).
If this is your first time contributing, consider searching for [unassigned issues that also have the `info: good first issue` label](https://github.com/csjewell/activitypub-ts-kit/issues?q=is%3Aissue+is%3Aopen+label%3A%22info:+good+first+issue%22+label%3A%22status%3A+accepting+prs%22+no%3Aassignee+).
...
Check [previously merged PRs](https://github.com/csjewell/activitypub-ts-kit/pulls?q=is%3Apr+is%3Amerged+-label%3Adependencies+) for reference.

You will want to create your pull request off of the *dev* branch, as they
will be merged back to that branch. The *release* branch is only for
"release-engineering" work, and it'll only be merged to right before a
release is cut. 
...
Once all feedback is addressed and the PR is approved, we'll ensure the branch is up to date with `dev` and merge it for you.
