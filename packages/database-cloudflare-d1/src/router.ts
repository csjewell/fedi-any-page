...
export class CloudflareD1Database implements Database.Router<D1Database, unknown> {
  ...
  protected env      : Configuration<D1Database, unknown>
  protected debugDB  : boolean = false

  constructor(env: Configuration<D1Database, unknown>) {
  ...
  getUsername(dr: string | AP.EntityReference | Array<AP.EntityReference> | null | undefined): DBUsername {
    if (Array.isArray(dr) || dr === undefined || dr === null) {
      return { username: undefined, usernameId: undefined, } as DBUsername
    }
  ...
  getDocument(dr: string | AP.EntityReference | Array<AP.EntityReference> | null | undefined): DBDocument {
    if (Array.isArray(dr) || dr === undefined || dr === null) {
      return { object: undefined, objectId: undefined, } as DBDocument
    }
