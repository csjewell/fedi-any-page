# @csjewell-activitypub/database-better-sqlite

This is a database to use that uses the better-sqlite TypeScript module.
...
[![JSR](https://jsr.io/badges/@csjewell-activitypub/localserver-hapi?style=plastic)](https://jsr.io/@csjewell-activitypub/localserver-hapi)
[![NPM](https://img.shields.io/npm/v/%40csjewell-activitypub%2Flocalserver-hapi.svg)](https://npmjs.com/package/@csjewell-activitypub/localserver-hapi)

## Usage

```shell
pnpm install @csjewell-activitypub/database-better-sqlite
```
