 ...
 */
import { type Database as APDatabase, NotImplementedError, Utils } from '@csjewell-activitypub/general'
...
implements APDatabase.StorageHandler<AP.Follow> {
  ...
  constructor(router: SQLiteDatabase, message: AP.Follow) {
    this.router = router
