 ...
 */
import { type Configuration, type Database as APDatabase, NotImplementedError } from '@csjewell-activitypub/general'
 ...
 *
 */
export class SQLiteConfig implements Configuration<Database> {
  public readonly url        : URL
  public readonly privateKey : string
  public readonly database   : APDatabase.Router<Database>
