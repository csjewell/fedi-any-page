...
[![JSR](https://jsr.io/badges/@csjewell-activitypub/general?style=plastic)](https://jsr.io/@csjewell-activitypub/general)
[![NPM](https://img.shields.io/npm/v/%40csjewell-activitypub%2Fgeneral.svg)](https://npmjs.com/package/@csjewell-activitypub/general)

## Usage

```shell
pnpm install @csjewell-activitypub/general
```
