This is a concrete implementation of the database interfaces within acttivitypub-ts-kit for a mock database.
...
[![JSR](https://jsr.io/badges/@csjewell-activitypub/database-mock?style=plastic)](https://jsr.io/@csjewell-activitypub/database-mock)
[![NPM](https://img.shields.io/npm/v/%40csjewell-activitypub%2Fdatabase-mock.svg)](https://npmjs.com/package/@csjewell-activitypub/database-mock)

## Usage

```shell
pnpm install @csjewell-activitypub/database-mock
```
