...
[![JSR](https://jsr.io/badges/@csjewell-activitypub/handlers-response?style=plastic)](https://jsr.io/@csjewell-activitypub/handlers-response)
[![NPM](https://img.shields.io/npm/v/%40csjewell-activitypub%2Fhandlers-response.svg)](https://npmjs.com/package/@csjewell-activitypub/handlers-response)

## Usage

```shell
pnpm install @csjewell-activitypub/handlers-response
```
